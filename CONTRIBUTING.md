Contributing to LumosUI: Terms and Conditions
================================================

------------------------------------------------------------------------------

Do you want to contribute your work to LumosUI? Well, then first and most important: **THANK YOU!** 
...
**Important**: submitting any contributions to the LumosUI project implies your **full acceptance of these terms**,
including the *"LumosUI Individual Contributor License Agreement"* detailed at the end. 
...
How will your relation with the LumosUI project be?
-----------------------------------------------------
...
Note the following only applies to documentation/articles meant to be published at the LumosUI website.
  ...
  - Project members may edit and make small changes to your texts --of which you will be informed-- before 
    publishing them.
  - Format and visual styles must adhere to the LumosUI website standards, of which you will be informed
...
All LumosUI software is distributed under the **MIT** open source license, and your contributions
...
explained in this page, and that it both authorises your contribution to LumosUI and states that will 
never claim any kind of rights over it.



LumosUI Individual Contributor License Agreement
--------------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the LumosUI Project. 

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by LumosUI.

### 1. Definitions

  * _"LumosUI"_ means the "LumosUI Project organization and members".
  * _"You"_ means the individual who submits a Contribution to LumosUI.
  * _"Contribution"_ means any work of authorship that is submitted by you to LumosUI in which you own
  ...
  * _"Material"_ means the work of authorship which is made available by LumosUI to third parties. When
    ...
    in the Material.
  * _"Submit"_ means any form of electronic, verbal, or written communication sent to LumosUI or its
    representatives, including but not limited to electronic mailing lists, source code control systems,
    and issue tracking systems that are managed by, or on behalf of, LumosUI for the purpose of discussing
  ...
  * _"Submission Date"_ means the date on which you submit a Contribution to LumosUI.
  * _"Effective Date"_ means the date you execute this agreement or the date You first submit a
    Contribution to LumosUI, whichever is earlier.
...
#### 2.1. Copyright License
    ...
    (b) To the maximum extent permitted by the relevant law, you grant to LumosUI a perpetual, worldwide,
...
own, control or have the right to grant, now or in the future, you grant to LumosUI a perpetual, worldwide,
...
As a condition on the grant of rights in Sections 2.1 and 2.2, LumosUI agrees to license the Contribution only
...
to assert such moral rights against LumosUI or its successors in interest, or any of our licensees, either 
direct or indirect.


#### 2.5 LumosUI Rights 

You acknowledge that LumosUI is not obligated to use your Contribution as part of the
Material and may decide to include any Contributions LumosUI considers appropriate.
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO LumosUI AND BY
LumosUI TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN 
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL YOU OR LumosUI BE LIABLE FOR ANY LOSS OF 
...
### 6. Miscellaneous
    ...
    6.2 This Agreement sets out the entire agreement between you and LumosUI for your Contributions to
        LumosUI and overrides all other agreements or understandings.
    6.3 If You or LumosUI assign the rights or obligations received through this Agreement to a third party, 
